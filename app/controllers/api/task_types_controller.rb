  ...
  class TaskTypesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @task_type.save
          format.html { redirect_to @task_type, notice: 'Work category was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @task_type.update(work_category_params)
          format.html { redirect_to @task_type, notice: 'Work category was successfully updated.' }
