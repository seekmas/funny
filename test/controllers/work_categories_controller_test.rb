...
class WorkCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create work_category" do
    assert_difference('WorkCategory.count') do
      post :create, work_category: { is_allowed: @work_category.is_allowed, name: @work_category.name, project_id: @work_category.project_id }
    end
  ...
  test "should update work_category" do
    patch :update, id: @work_category, work_category: { is_allowed: @work_category.is_allowed, name: @work_category.name, project_id: @work_category.project_id }
    assert_redirected_to work_category_path(assigns(:work_category))
  end
